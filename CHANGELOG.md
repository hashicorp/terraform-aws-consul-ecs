...
IMPROVEMENTS
* Introducing validation checks for networkPartitionResilienceConfig [[GH-376](https://github.com/hashicorp/terraform-aws-consul-ecs/pull/376)]
...
IMPROVEMENTS
* Bump Consul image to `1.21.5`
* Bump Consul Dataplane image to `1.8.2`
